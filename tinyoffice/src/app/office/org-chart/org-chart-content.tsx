...
function OrgChartInner() {
  const { data: agents } = useSSEPolling<Record<string, AgentConfig>>(getAgents, 0, ["agents:changed", "settings:changed"]);
  const { data: teams } = useSSEPolling<Record<string, TeamConfig>>(getTeams, 0, ["teams:changed", "settings:changed"]);
